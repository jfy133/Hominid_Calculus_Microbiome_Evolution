...
```{r}
data_raw <- Sys.glob("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/presenceabsence_intersection.backup") %>%
...
plot_mhc
 ...
 ggsave(paste("99-coremicrobiome_presenceabsence_alluival_minsupportcomparison_", format(Sys.Date(), "%Y%m%d"),".pdf", sep = ""), 
        plot_mhc, 
        path = "/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/presenceabsence_intersection.backup/", 
        device = cairo_pdf, 
        width = 7,
        height = 5, 
        units = "in",
...
write_tsv(data_minsup_mhc, paste("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/presenceabsence_intersection.backup/99-coremicrobiome_presenceabsence_table_minsupportcomparison_", format(Sys.Date(), "%Y%m%d"),".tsv", sep = ""))
```
...
write_tsv(data_singpop_save, paste("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/presenceabsence_intersection.backup/99-coremicrobiome_presenceabsence_table_singleindpopcomparison_", format(Sys.Date(), "%Y%m%d"),".tsv", sep = ""))
...
```{r}
metadata <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/00-documentation.backup/02-calculus_microbiome-deep_evolution-individualscontrolssources_metadata_20190523.tsv") %>%
 rename(Individual = `#SampleID`)

  data_out_sampfil <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/cumulative_decay.backup/cumulativeproportiondecay_burninwithinfluctuationSDvariation_nt_fractionOralThreshold_50_20190509.tsv")
  
  bad_samples <- data_out_sampfil %>% 
      filter(!withinfluctuationvariation_pass) %>%
      pull(sample)
  
   contaminants_species <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/decontam.backup/decontam_taxa_to_remove_megan_nt_species_combined_0.99_190411.tsv")
   
   ## At Species Level
 raw_malt_species <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/megan.backup/Evolution-Comparison_MEGAN_20190401-ex_absolute_species_prokaryotes_summarised_nt.txt")
