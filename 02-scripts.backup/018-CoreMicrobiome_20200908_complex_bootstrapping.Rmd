...
minsupp_multiplier <- 4 ## multiplier against 0.01 minsupport or tail removal
...
## Remove controls
if ( !controls ) {
  full_data_meta <- full_data_meta %>% filter(Sample_or_Control == "Sample")
} 
