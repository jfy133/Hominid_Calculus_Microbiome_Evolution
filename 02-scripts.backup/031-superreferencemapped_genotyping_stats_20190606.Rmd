...
```{r}
data_representativemapping_raw <- Sys.glob("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/eager/*/output/*") %>%
...
```{r eval = F}
## Set dir
main_dir <- Sys.glob("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/eager/superreference_mapping/output/*/*/5-DeDup/")
...
```{r eval = F}
write_tsv(data_all, paste("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/competitive_mapping.backup/superreference_mapping_statistics_raw_", format(Sys.Date(), "%Y%m%d"), ".tsv.gz", sep = ""))
```
...
```{r}
data_all <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/competitive_mapping.backup/superreference_mapping_statistics_raw_20190522.tsv.gz") %>%
  print()
```
...
```{r eval = F}
write_tsv(data_all_collapsed_meta, paste("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/competitive_mapping.backup/superreference_mapping_statistics_final_", format(Sys.Date(), "%Y%m%d"), ".tsv", sep = ""))
```
...
```{r}
data_all_collapsed_meta <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/competitive_mapping.backup/superreference_mapping_statistics_final_20190522.tsv")
...
write_tsv(data_mappingstats_all, paste0("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/competitive_mapping.backup/superreference_singlegenome_mappingstats_comparison", format(Sys.Date(), "%Y%m%d"), ".tsv"))
```
...
plot_linegraph <- function(my_genus, metric_col, mean_col, sd_col){
  ...
  out_plot <- ggplot(data_all_collapsed_meta %>% filter(genus == my_genus), aes_string("species", 
    ...
    ggsave(paste("superreferencemapping_statistics_lineplot_", 
                 ...
                 ".pdf", 
                 sep = ""), plot = out_plot,
           "/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/competitive_mapping.backup/species_selection/", 
           device = cairo_pdf, 
           width = 14, 
           height = 7, 
           units = "in", 
...
write_tsv(results_filter, "/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/competitive_mapping.backup/superreference_speciespassingfilter.tsv")
