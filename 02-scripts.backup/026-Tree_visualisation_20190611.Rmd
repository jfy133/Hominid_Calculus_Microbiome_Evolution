...
````{r}
  ...
  final_tree <- ggtree(my_tree, 
    ...
    ggsave(paste0(taxon_name, "-", 
                  ...
                  ".pdf"),
           path = "../04-analysis/deep/phylogenies/plots/",
           final_tree,
           device = cairo_pdf,
           width = 3.5,
           height = 5,
...
analysis_dirs <- Sys.glob("../04-analysis/deep/multivcfanalyzer/*/output/*_2X_0.7_0.7/*/")
...
```{r}
sample_metadata <- read_tsv("../00-documentation.backup/17-Deep_Sequencing_HumanFiltering_Results_20190307.tsv")
```
