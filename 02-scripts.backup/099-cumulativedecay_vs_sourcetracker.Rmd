...
```{r}
proj_dir <- "/home/fellows/Dropbox (MPI SHH)/Projects/0-Calculus_Oral_Evolution/1-Oral_Deep_Evolution/06-manuscripts/SupplementaryFigures/cufredec_vs_sourcetracker/"
```
...
ggsave(paste0("SupFigX_SourcetrackerVsCPD_st2bar_cpdtext_" ,
       ...
       path = "/home/fellows/Dropbox (MPI SHH)/Projects/0-Calculus_Oral_Evolution/1-Oral_Deep_Evolution/06-manuscripts/SupplementaryFigures/cufredec_vs_sourcetracker",
       device = cairo_pdf,
       width = 7,
       height = 3,
       units = "in",
