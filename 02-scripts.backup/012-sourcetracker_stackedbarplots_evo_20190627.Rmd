...
```{r}
## load data
 st2_raw_both <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/sourcetracker.backup/otu_table_L6_1000_20190520/sink_predictions.txt")

 st2_meta <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/00-documentation.backup/02-calculus_microbiome-deep_evolution-individualscontrolssources_metadata_20190509.tsv")
...
ggsave(plot = barplot_prefilter, 
       ...
       "/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/sourcetracker.backup/", 
       device = cairo_pdf, 
       width = 7, 
       height = 3.5,
       units = "in", 
...
write_tsv(st2_filtering_calculations, 
          paste("/home/fellows/projects1/microbiome_calculus/evolution/00-documentation.backup/06-sourcetracker_filtering_results_", format(Sys.Date(), format = "%y%m%d"), ".tsv", sep = ""))
...
samples_to_retain %>%
  ...
  group_by(Env) %>% 
  summarise(No_Individuals = sum(!more_env)) %>% write_tsv(paste("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/sourcetracker.backup/post_filter_individual_hostgenuspopulation_counts_", format(Sys.Date(), "%Y%m%d"), ".tsv", sep = "")) %>% 
  print
...
samples_to_retain %>%
  ...
  write_tsv(paste("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/sourcetracker.backup/post_filter_individual_hostgenus_counts_", format(Sys.Date(), "%Y%m%d"), ".tsv", sep = "")) %>% print
