...
```{r}
metadata <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/00-documentation.backup/17-Deep_Sequencing_HumanFiltering_Results_20190307.tsv") %>% select(sample_name, Env, Host_Genus, Host_Common) %>%
...
```{r, eval = F}
dat <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/virulence_investigation.backup/red_complex_virulence_factors.tsv") %>% filter(!Species == "Treponema_denticola")
...
write_tsv(results_clean, "
          /home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/virulence_investigation.backup/red_complex_virulence_factors_GCA.tsv")
```

Then I manually converted the results into bed format, stored here:

`/projects1/microbiome_calculus/evolution/04-analysis/deep/virulence_investigation.backup/tf_pg_virulence.bed`

Loaded here (from is in bed format)

```{r}
data_virulence_pos <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/virulence_investigation.backup/tf_pg_virulence.bed", col_names = c("chrom", "start", "end", "desc", "empty")) %>%
...
genome_data <- Sys.glob("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/eager/initial_single_genome/output/*/") %>%
...
```{r}
breadth <- Sys.glob("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/eager/initial_single_genome/output/*/*/5-DeDup") %>%
...
depth <- Sys.glob("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/eager/initial_single_genome/output/*/*/5-DeDup") %>%
...
```{r}
raw <- Sys.glob("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/eager/initial_single_genome/output/*/*/5-DeDup") %>%
...
```{r}
breadth_all <- Sys.glob("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/eager/initial_single_genome/output/*/*/5-DeDup") %>%
...
depth_all <- Sys.glob("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/deep/eager/initial_single_genome/output/*/*/5-DeDup") %>%
...
ggplot2::ggsave("FigSX_VirulenceNormalisation_Breadth_GeneFilter.pdf", plot = gene_filter_plot_both, path = "/home/fellows/Dropbox (MPI SHH)/Projects/0-Calculus_Oral_Evolution/1-Oral_Deep_Evolution/06-manuscripts/SupplementaryFigures/VirulenceFactors", device = cairo_pdf, width = 7, height = 3.5, units = "in")
ggplot2::ggsave("FigSX_VirulenceNormalisation_Breadth_GeneFilter.png", plot = gene_filter_plot_both, path = "/home/fellows/Dropbox (MPI SHH)/Projects/0-Calculus_Oral_Evolution/1-Oral_Deep_Evolution/06-manuscripts/SupplementaryFigures/VirulenceFactors", width = 7, height = 3.5, units = "in", dpi = 600)
```
...
ggplot2::ggsave("FigSX_Virulence_AllAnnotatedGene_Virulence_Ratios.pdf", plot = final_ratio_plot2_both, path = "/home/fellows/Dropbox (MPI SHH)/Projects/0-Calculus_Oral_Evolution/1-Oral_Deep_Evolution/06-manuscripts/SupplementaryFigures/VirulenceFactors", device = cairo_pdf, width = 7, height = 3.5, units = "in")
ggplot2::ggsave("FigSX_Virulence_AllAnnotatedGene_Virulence_Ratios.png", plot = final_ratio_plot2_both, path = "/home/fellows/Dropbox (MPI SHH)/Projects/0-Calculus_Oral_Evolution/1-Oral_Deep_Evolution/06-manuscripts/SupplementaryFigures/VirulenceFactors", width = 7, height = 3.5, units = "in", dpi = 600)
```
