...
abpA_aa <-  read.alignment(file = "GC00002917_aa_aln.fa", format = "fasta")
abpB_aa <- read.alignment(file = "GC00000227_1_aa_aln.fa", format = "fasta")

## nucleotide alignment
abpA_na <-  read.alignment(file = "GC00002917_na_aln.fa", format = "fasta")
abpB_na <- read.alignment(file = "GC00000227_1_na_aln.fa", format = "fasta")
```
...
This only reuslts in 2 similar sequences, one is it'self, and another
...
all_abpA_aa_aln %>% select(name) %>% rename(Annotation = name) %>%
  write_tsv("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/streptococcus_investigation.backup/panX/selected_panX_abpA_annotations.tsv")
```
...
all_abpB_aa_aln %>% 
  ...
  write_tsv("/home/fellows/projects1/microbiome_calculus/evolution/04-analysis/screening/streptococcus_investigation.backup/panX/selected_panX_abpB_annotations.tsv")
