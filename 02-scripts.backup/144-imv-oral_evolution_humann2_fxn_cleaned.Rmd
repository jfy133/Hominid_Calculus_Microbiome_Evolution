...
```{r adonis_KOs_outrem_outcont_outpq}

# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
H2KO.euc <- vegdist(H2KO.pca$X, method = "euclidean", na.rm = T)
H2KO.euc.pcoa <- ape::pcoa(H2KO.euc)

H2KO.euc.pcoavectors <- as.data.frame(H2KO.euc.pcoa$vectors)
H2KO.euc.pcoavectors <- H2KO.euc.pcoavectors %>%
  rownames_to_column("SampleID")

H2KO.euc.vecmet <- inner_join(H2KO.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")
...
adonis2(H2KO.euc ~ Host_Genus, H2KO.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
h2_KO_aminoacids.euc <- vegdist(h2_KO_aminoacids.pca$X, method = "euclidean", na.rm = T)
h2_KO_aminoacids.euc.pcoa <- ape::pcoa(h2_KO_aminoacids.euc)

h2_KO_aminoacids.euc.pcoavectors <- as.data.frame(h2_KO_aminoacids.euc.pcoa$vectors)
h2_KO_aminoacids.euc.pcoavectors <- h2_KO_aminoacids.euc.pcoavectors %>%
  rownames_to_column("SampleID")

h2_KO_aminoacids.euc.vecmet <- inner_join(h2_KO_aminoacids.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")

h2_KO_aminoacids.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(h2_KO_aminoacids.euc ~ Host_Genus, h2_KO_aminoacids.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
h2_KO_carbs.euc <- vegdist(h2_KO_carbs.pca$X, method = "euclidean", na.rm = T)
h2_KO_carbs.euc.pcoa <- ape::pcoa(h2_KO_carbs.euc)

h2_KO_carbs.euc.pcoavectors <- as.data.frame(h2_KO_carbs.euc.pcoa$vectors)
h2_KO_carbs.euc.pcoavectors <- h2_KO_carbs.euc.pcoavectors %>%
  rownames_to_column("SampleID")

h2_KO_carbs.euc.vecmet <- inner_join(h2_KO_carbs.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")

h2_KO_carbs.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(h2_KO_carbs.euc ~ Host_Genus, h2_KO_carbs.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
h2_KO_cofvit.euc <- vegdist(h2_KO_cofvit.pca$X, method = "euclidean", na.rm = T)
h2_KO_cofvit.euc.pcoa <- ape::pcoa(h2_KO_cofvit.euc)

h2_KO_cofvit.euc.pcoavectors <- as.data.frame(h2_KO_cofvit.euc.pcoa$vectors)
h2_KO_cofvit.euc.pcoavectors <- h2_KO_cofvit.euc.pcoavectors %>%
  rownames_to_column("SampleID")

h2_KO_cofvit.euc.vecmet <- inner_join(h2_KO_cofvit.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")

h2_KO_cofvit.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(h2_KO_cofvit.euc ~ Host_Genus, h2_KO_cofvit.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
h2_KO_energy.euc <- vegdist(h2_KO_energy.pca$X, method = "euclidean", na.rm = T)
h2_KO_energy.euc.pcoa <- ape::pcoa(h2_KO_energy.euc)

h2_KO_energy.euc.pcoavectors <- as.data.frame(h2_KO_energy.euc.pcoa$vectors)
h2_KO_energy.euc.pcoavectors <- h2_KO_energy.euc.pcoavectors %>%
  rownames_to_column("SampleID")

h2_KO_energy.euc.vecmet <- inner_join(h2_KO_energy.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")

h2_KO_energy.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(h2_KO_energy.euc ~ Host_Genus, h2_KO_energy.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
h2_KO_glycans.euc <- vegdist(h2_KO_glycans.pca$X, method = "euclidean", na.rm = T)
h2_KO_glycans.euc.pcoa <- ape::pcoa(h2_KO_glycans.euc)

h2_KO_glycans.euc.pcoavectors <- as.data.frame(h2_KO_glycans.euc.pcoa$vectors)
h2_KO_glycans.euc.pcoavectors <- h2_KO_glycans.euc.pcoavectors %>%
  rownames_to_column("SampleID")

h2_KO_glycans.euc.vecmet <- inner_join(h2_KO_glycans.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")

h2_KO_glycans.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(h2_KO_glycans.euc ~ Host_Genus, h2_KO_glycans.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
h2_KO_lipids.euc <- vegdist(h2_KO_lipids.pca$X, method = "euclidean", na.rm = T)
h2_KO_lipids.euc.pcoa <- ape::pcoa(h2_KO_lipids.euc)

h2_KO_lipids.euc.pcoavectors <- as.data.frame(h2_KO_lipids.euc.pcoa$vectors)
h2_KO_lipids.euc.pcoavectors <- h2_KO_lipids.euc.pcoavectors %>%
  rownames_to_column("SampleID")

h2_KO_lipids.euc.vecmet <- inner_join(h2_KO_lipids.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")

h2_KO_lipids.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(h2_KO_lipids.euc ~ Host_Genus, h2_KO_lipids.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
h2_KO_membrane.euc <- vegdist(h2_KO_membrane.pca$X, method = "euclidean", na.rm = T)
h2_KO_membrane.euc.pcoa <- ape::pcoa(h2_KO_membrane.euc)

h2_KO_membrane.euc.pcoavectors <- as.data.frame(h2_KO_membrane.euc.pcoa$vectors)
h2_KO_membrane.euc.pcoavectors <- h2_KO_membrane.euc.pcoavectors %>%
  rownames_to_column("SampleID")

h2_KO_membrane.euc.vecmet <- inner_join(h2_KO_membrane.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")

h2_KO_membrane.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(h2_KO_membrane.euc ~ Host_Genus, h2_KO_membrane.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
h2_KO_motility.euc <- vegdist(h2_KO_motility.pca$X, method = "euclidean", na.rm = T)
h2_KO_motility.euc.pcoa <- ape::pcoa(h2_KO_motility.euc)

h2_KO_motility.euc.pcoavectors <- as.data.frame(h2_KO_motility.euc.pcoa$vectors)
h2_KO_motility.euc.pcoavectors <- h2_KO_motility.euc.pcoavectors %>%
  rownames_to_column("SampleID")

h2_KO_motility.euc.vecmet <- inner_join(h2_KO_motility.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")

h2_KO_motility.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(h2_KO_motility.euc ~ Host_Genus, h2_KO_motility.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
h2_KO_nucleotide.euc <- vegdist(h2_KO_nucleotide.pca$X, method = "euclidean", na.rm = T)
h2_KO_nucleotide.euc.pcoa <- ape::pcoa(h2_KO_nucleotide.euc)

h2_KO_nucleotide.euc.pcoavectors <- as.data.frame(h2_KO_nucleotide.euc.pcoa$vectors)
h2_KO_nucleotide.euc.pcoavectors <- h2_KO_nucleotide.euc.pcoavectors %>%
  rownames_to_column("SampleID")

h2_KO_nucleotide.euc.vecmet <- inner_join(h2_KO_nucleotide.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")

h2_KO_nucleotide.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(h2_KO_nucleotide.euc ~ Host_Genus, h2_KO_nucleotide.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
h2_KO_replic.euc <- vegdist(h2_KO_replic.pca$X, method = "euclidean", na.rm = T)
h2_KO_replic.euc.pcoa <- ape::pcoa(h2_KO_replic.euc)

h2_KO_replic.euc.pcoavectors <- as.data.frame(h2_KO_replic.euc.pcoa$vectors)
h2_KO_replic.euc.pcoavectors <- h2_KO_replic.euc.pcoavectors %>%
  rownames_to_column("SampleID")

h2_KO_replic.euc.vecmet <- inner_join(h2_KO_replic.euc.pcoavectors, selectmetadata %>% rename(SampleID = individual_id) %>% select(SampleID, Host_Genus), by = "SampleID")

h2_KO_replic.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(h2_KO_replic.euc ~ Host_Genus, h2_KO_replic.euc.vecmet, permutations = 999, by = "margin")
