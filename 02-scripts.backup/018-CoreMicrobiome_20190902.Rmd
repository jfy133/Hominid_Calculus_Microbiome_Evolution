...
drop_single <- T ## whether to drop populations with only single individuals
script <- F
save_upsetr <- F
###########################################
...
metadata <- read_tsv("../02-calculus_microbiome-deep_evolution-individualscontrolssources_metadata_20190523.tsv") %>%
