...
```{r adonis_L4_calculus}

# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
decontam.outrem.calc.aadder_L4.euc <- vegdist(decontam.outrem.calc.aadder_L4.pca$X, method = "euclidean", na.rm = T)
decontam.outrem.calc.aadder_L4.euc.pcoa <- ape::pcoa(decontam.outrem.calc.aadder_L4.euc)

decontam.outrem.calc.aadder_L4.euc.pcoavectors <- as.data.frame(decontam.outrem.calc.aadder_L4.euc.pcoa$vectors)
decontam.outrem.calc.aadder_L4.euc.pcoavectors <- decontam.outrem.calc.aadder_L4.euc.pcoavectors %>%
  rownames_to_column("SampleID")

decontam.outrem.calc.aadder_L4.euc.vecmet <- inner_join(decontam.outrem.calc.aadder_L4.euc.pcoavectors, fullmetadata %>% select(SampleID, Host_Genus), by = "SampleID")

decontam.outrem.calc.aadder_L4.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
  stat_ellipse(aes(colour = Host_Genus, group = Host_Genus)) +
  theme_minimal(base_size = 7) +
  ggtitle("Host_Genus")

# test for difference between different metadata categories 
adonis2(decontam.outrem.calc.aadder_L4.euc ~ Host_Genus, decontam.outrem.calc.aadder_L4.euc.vecmet, permutations = 999, by = "margin")
...
```{r adonis_amino_acids}

# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
decontam.outrem.calc.aminoacid.aadder_L4.euc <- vegdist(decontam.outrem.calc.aminoacid.aadder_L4.pca$X, method = "euclidean", na.rm = T)
decontam.outrem.calc.aminoacid.aadder_L4.euc.pcoa <- ape::pcoa(decontam.outrem.calc.aminoacid.aadder_L4.euc)

decontam.outrem.calc.aminoacid.aadder_L4.euc.pcoavectors <- as.data.frame(decontam.outrem.calc.aminoacid.aadder_L4.euc.pcoa$vectors)
decontam.outrem.calc.aminoacid.aadder_L4.euc.pcoavectors <- decontam.outrem.calc.aminoacid.aadder_L4.euc.pcoavectors %>%
  rownames_to_column("SampleID")

decontam.outrem.calc.aminoacid.aadder_L4.euc.vecmet <- inner_join(decontam.outrem.calc.aminoacid.aadder_L4.euc.pcoavectors, fullmetadata %>% select(SampleID, Host_Genus), by = "SampleID")

decontam.outrem.calc.aminoacid.aadder_L4.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(decontam.outrem.calc.aminoacid.aadder_L4.euc ~ Host_Genus, decontam.outrem.calc.aminoacid.aadder_L4.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
decontam.outrem.calc.carb.aadder_L4.euc <- vegdist(decontam.outrem.calc.carb.aadder_L4.pca$X, method = "euclidean", na.rm = T)
decontam.outrem.calc.carb.aadder_L4.euc.pcoa <- ape::pcoa(decontam.outrem.calc.carb.aadder_L4.euc)

decontam.outrem.calc.carb.aadder_L4.euc.pcoavectors <- as.data.frame(decontam.outrem.calc.carb.aadder_L4.euc.pcoa$vectors)
decontam.outrem.calc.carb.aadder_L4.euc.pcoavectors <- decontam.outrem.calc.carb.aadder_L4.euc.pcoavectors %>%
  rownames_to_column("SampleID")

decontam.outrem.calc.carb.aadder_L4.euc.vecmet <- inner_join(decontam.outrem.calc.carb.aadder_L4.euc.pcoavectors, fullmetadata %>% select(SampleID, Host_Genus), by = "SampleID")

decontam.outrem.calc.carb.aadder_L4.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(decontam.outrem.calc.carb.aadder_L4.euc ~ Host_Genus, decontam.outrem.calc.carb.aadder_L4.euc.vecmet, permutations = 999, by = "margin")
...
```{r adonis_cofactors_vitamins}

# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
decontam.outrem.calc.cofvit.aadder_L4.euc <- vegdist(decontam.outrem.calc.cofvit.aadder_L4.pca$X, method = "euclidean", na.rm = T)
decontam.outrem.calc.cofvit.aadder_L4.euc.pcoa <- ape::pcoa(decontam.outrem.calc.cofvit.aadder_L4.euc)

decontam.outrem.calc.cofvit.aadder_L4.euc.pcoavectors <- as.data.frame(decontam.outrem.calc.cofvit.aadder_L4.euc.pcoa$vectors)
decontam.outrem.calc.cofvit.aadder_L4.euc.pcoavectors <- decontam.outrem.calc.cofvit.aadder_L4.euc.pcoavectors %>%
  rownames_to_column("SampleID")

decontam.outrem.calc.cofvit.aadder_L4.euc.vecmet <- inner_join(decontam.outrem.calc.cofvit.aadder_L4.euc.pcoavectors, fullmetadata %>% select(SampleID, Host_Genus), by = "SampleID")

decontam.outrem.calc.cofvit.aadder_L4.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(decontam.outrem.calc.cofvit.aadder_L4.euc ~ Host_Genus, decontam.outrem.calc.cofvit.aadder_L4.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
decontam.outrem.calc.cellwall.aadder_L4.euc <- vegdist(decontam.outrem.calc.cellwall.aadder_L4.pca$X, method = "euclidean", na.rm = T)
decontam.outrem.calc.cellwall.aadder_L4.euc.pcoa <- ape::pcoa(decontam.outrem.calc.cellwall.aadder_L4.euc)

decontam.outrem.calc.cellwall.aadder_L4.euc.pcoavectors <- as.data.frame(decontam.outrem.calc.cellwall.aadder_L4.euc.pcoa$vectors)
decontam.outrem.calc.cellwall.aadder_L4.euc.pcoavectors <- decontam.outrem.calc.cellwall.aadder_L4.euc.pcoavectors %>%
  rownames_to_column("SampleID")

decontam.outrem.calc.cellwall.aadder_L4.euc.vecmet <- inner_join(decontam.outrem.calc.cellwall.aadder_L4.euc.pcoavectors, fullmetadata %>% select(SampleID, Host_Genus), by = "SampleID")

decontam.outrem.calc.cellwall.aadder_L4.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(decontam.outrem.calc.cellwall.aadder_L4.euc ~ Host_Genus, decontam.outrem.calc.cellwall.aadder_L4.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
decontam.outrem.calc.fattyacids.aadder_L4.euc <- vegdist(decontam.outrem.calc.fattyacids.aadder_L4.pca$X, method = "euclidean", na.rm = T)
decontam.outrem.calc.fattyacids.aadder_L4.euc.pcoa <- ape::pcoa(decontam.outrem.calc.fattyacids.aadder_L4.euc)

decontam.outrem.calc.fattyacids.aadder_L4.euc.pcoavectors <- as.data.frame(decontam.outrem.calc.fattyacids.aadder_L4.euc.pcoa$vectors)
decontam.outrem.calc.fattyacids.aadder_L4.euc.pcoavectors <- decontam.outrem.calc.fattyacids.aadder_L4.euc.pcoavectors %>%
  rownames_to_column("SampleID")

decontam.outrem.calc.fattyacids.aadder_L4.euc.vecmet <- inner_join(decontam.outrem.calc.fattyacids.aadder_L4.euc.pcoavectors, fullmetadata %>% select(SampleID, Host_Genus), by = "SampleID")

decontam.outrem.calc.fattyacids.aadder_L4.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(decontam.outrem.calc.fattyacids.aadder_L4.euc ~ Host_Genus, decontam.outrem.calc.fattyacids.aadder_L4.euc.vecmet, permutations = 999, by = "margin")
...
# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
decontam.outrem.calc.membrane.aadder_L4.euc <- vegdist(decontam.outrem.calc.membrane.aadder_L4.pca$X, method = "euclidean", na.rm = T)
decontam.outrem.calc.membrane.aadder_L4.euc.pcoa <- ape::pcoa(decontam.outrem.calc.membrane.aadder_L4.euc)

decontam.outrem.calc.membrane.aadder_L4.euc.pcoavectors <- as.data.frame(decontam.outrem.calc.membrane.aadder_L4.euc.pcoa$vectors)
decontam.outrem.calc.membrane.aadder_L4.euc.pcoavectors <- decontam.outrem.calc.membrane.aadder_L4.euc.pcoavectors %>%
  rownames_to_column("SampleID")

decontam.outrem.calc.membrane.aadder_L4.euc.vecmet <- inner_join(decontam.outrem.calc.membrane.aadder_L4.euc.pcoavectors, fullmetadata %>% select(SampleID, Host_Genus), by = "SampleID")

decontam.outrem.calc.membrane.aadder_L4.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(decontam.outrem.calc.membrane.aadder_L4.euc ~ Host_Genus, decontam.outrem.calc.membrane.aadder_L4.euc.vecmet, permutations = 999, by = "margin")
...
```
There isn't enough variation in the motility-related genes to run this
```{r adonis_motility, eval = F}

# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
decontam.outrem.calc.motility.aadder_L4.euc <- vegdist(decontam.outrem.calc.motility.aadder_L4.pca$X, method = "euclidean", na.rm = T)
decontam.outrem.calc.motility.aadder_L4.euc.pcoa <- ape::pcoa(decontam.outrem.calc.motility.aadder_L4.euc)

decontam.outrem.calc.motility.aadder_L4.euc.pcoavectors <- as.data.frame(decontam.outrem.calc.motility.aadder_L4.euc.pcoa$vectors)
decontam.outrem.calc.motility.aadder_L4.euc.pcoavectors <- decontam.outrem.calc.motility.aadder_L4.euc.pcoavectors %>%
  rownames_to_column("SampleID")

decontam.outrem.calc.motility.aadder_L4.euc.vecmet <- inner_join(decontam.outrem.calc.motility.aadder_L4.euc.pcoavectors, fullmetadata %>% select(SampleID, Host_Genus), by = "SampleID")

decontam.outrem.calc.motility.aadder_L4.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(decontam.outrem.calc.motility.aadder_L4.euc ~ Host_Genus, decontam.outrem.calc.motility.aadder_L4.euc.vecmet, permutations = 999, by = "margin")
...
```{r adonis_nucleotides}

# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
decontam.outrem.calc.nucleotide.aadder_L4.euc <- vegdist(decontam.outrem.calc.nucleotide.aadder_L4.pca$X, method = "euclidean", na.rm = T)
decontam.outrem.calc.nucleotide.aadder_L4.euc.pcoa <- ape::pcoa(decontam.outrem.calc.nucleotide.aadder_L4.euc)

decontam.outrem.calc.nucleotide.aadder_L4.euc.pcoavectors <- as.data.frame(decontam.outrem.calc.nucleotide.aadder_L4.euc.pcoa$vectors)
decontam.outrem.calc.nucleotide.aadder_L4.euc.pcoavectors <- decontam.outrem.calc.nucleotide.aadder_L4.euc.pcoavectors %>%
  rownames_to_column("SampleID")

decontam.outrem.calc.nucleotide.aadder_L4.euc.vecmet <- inner_join(decontam.outrem.calc.nucleotide.aadder_L4.euc.pcoavectors, fullmetadata %>% select(SampleID, Host_Genus), by = "SampleID")

decontam.outrem.calc.nucleotide.aadder_L4.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(decontam.outrem.calc.nucleotide.aadder_L4.euc ~ Host_Genus, decontam.outrem.calc.nucleotide.aadder_L4.euc.vecmet, permutations = 999, by = "margin")
...
```{r adonis_replication}

# Euclidean distance, uses the clr-transformed matrix from the mixOmics PCA above
decontam.outrem.calc.replication.aadder_L4.euc <- vegdist(decontam.outrem.calc.replication.aadder_L4.pca$X, method = "euclidean", na.rm = T)
decontam.outrem.calc.replication.aadder_L4.euc.pcoa <- ape::pcoa(decontam.outrem.calc.replication.aadder_L4.euc)

decontam.outrem.calc.replication.aadder_L4.euc.pcoavectors <- as.data.frame(decontam.outrem.calc.replication.aadder_L4.euc.pcoa$vectors)
decontam.outrem.calc.replication.aadder_L4.euc.pcoavectors <- decontam.outrem.calc.replication.aadder_L4.euc.pcoavectors %>%
  rownames_to_column("SampleID")

decontam.outrem.calc.replication.aadder_L4.euc.vecmet <- inner_join(decontam.outrem.calc.replication.aadder_L4.euc.pcoavectors, fullmetadata %>% select(SampleID, Host_Genus), by = "SampleID")

decontam.outrem.calc.replication.aadder_L4.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Host_Genus, shape = Host_Genus)) +
  geom_point(size = 3) +
  scale_colour_manual(values = genus_colours) +
  scale_shape_manual(values = genus_shapes) +
...
# test for difference between different metadata categories 
adonis2(decontam.outrem.calc.replication.aadder_L4.euc ~ Host_Genus, decontam.outrem.calc.replication.aadder_L4.euc.vecmet, permutations = 999, by = "margin")
...
decontam.outrem.calc.aadder_L4.pca_df$Host_Common <- factor(decontam.outrem.calc.aadder_L4.pca_df$Host_Common, 
