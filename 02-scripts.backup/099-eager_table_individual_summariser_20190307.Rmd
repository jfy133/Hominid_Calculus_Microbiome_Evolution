...
main_dir <- Sys.glob("/home/fellows/projects1/microbiome_calculus/evolution/03-preprocessing/deep/human_filtering/output/")
...
## Load metadata
data_meta <- read_tsv("/home/fellows/projects1/microbiome_calculus/evolution/00-documentation.backup/02-calculus_microbiome-deep_evolution-individualscontrolssources_metadata_20190523.tsv")
...
```{r eval = F}
write_tsv(data_summary, paste("/home/fellows/projects1/microbiome_calculus/evolution/00-documentation.backup/17-Deep_Sequencing_LibraryLevel_HumanFiltering_Results__", format(Sys.Date(), "%Y%m%d"),".tsv", sep = ""))
```
