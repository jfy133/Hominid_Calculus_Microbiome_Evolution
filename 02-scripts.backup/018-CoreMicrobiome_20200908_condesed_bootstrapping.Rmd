...
final_genus <- left_join(original_genus_result, genus_results$top_bsvalues_only) %>%
  write_tsv(., path = paste("../04-analysis/screening/presenceabsence_intersection.backup/99-coremicrobiome_presenceabsence_bootstrapped_",
    db,
    "_", minsupp_threshold,
    "_fracinds",
