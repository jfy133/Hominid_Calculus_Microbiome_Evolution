...
- [2 Resources](#2-resources)
  ...
  - [2.2 R Packages](#22-r-packages)
  - [2.3 Sequence Databases](#23-sequence-databases)
  - [2.4 Single Reference Genomes](#24-single-reference-genomes)
- [3 Repository Structure](#3-repository-structure)
  - [3.1 General Directory Structure](#31-general-directory-structure)
  - [3.2 Analysis Profile](#32-analysis-profile)
- [4 Database and Genome Indexing](#4-database-and-genome-indexing)
  - [4.1 MALT Database](#41-malt-database)
  - [4.2 AADDER Database](#42-aadder-database)
  - [4.3 BWA Indexing](#43-bwa-indexing)
  - [4.4 UniRef Database](#44-uniref-database)
  - [4.5 Database analysis profile](#45-database-analysis-profile)
- [5 Data Acquisition](#5-data-acquisition)
  - [5.1 Additional Individuals](#51-additional-individuals)
  - [5.2 Comparative Sources](#52-comparative-sources)
- [6 Data Preprocessing](#6-data-preprocessing)
  - [6.1 Preprocessing](#61-preprocessing)
    - [6.1.1 Script Version](#611-script-version)
    - [6.1.2 EAGER Version](#612-eager-version)
  - [6.2 Post-Processing](#62-post-processing)
    - [6.2.1 EAGER preprocessing dataset BAM to FASTQ Conversion](#621-eager-preprocessing-dataset-bam-to-fastq-conversion)
    - [6.2.2 Statistics](#622-statistics)
    - [6.2.3 Library Merging](#623-library-merging)
  - [6.3 Poly-G Trimming Assessment](#63-poly-g-trimming-assessment)
  - [6.4 Processing Results](#64-processing-results)
- [7 Metagenomic Screening](#7-metagenomic-screening)
  - [7.1 MALT](#71-malt)
    - [7.1.1 MALT Running](#711-malt-running)
    - [7.1.2 MALT Summary Statistics](#712-malt-summary-statistics)
  - [7.2 MEGAN](#72-megan)
    - [7.2.1 MEGAN Running](#721-megan-running)
    - [7.2.2 Additional Raw OTU Tables](#722-additional-raw-otu-tables)
    - [7.2.3 Prokaryotic vs. Eukaryotic MALT content Comparison](#723-prokaryotic-vs-eukaryotic-malt-content-comparison)
  - [7.3 Database Comparison](#73-database-comparison)
- [8 Preservation Screening](#8-preservation-screening)
  - [8.1 Cumulative Proportion Decay Plots](#81-cumulative-proportion-decay-plots)
  - [8.2 Source Estimation](#82-source-estimation)
    - [8.2.1 16S Extraction](#821-16s-extraction)
    - [8.2.2 16S Clustering](#822-16s-clustering)
    - [8.2.3 Sourcetracker](#823-sourcetracker)
  - [8.3 Ratio of Eukaryotic to Prokaryotic Alignments](#83-ratio-of-eukaryotic-to-prokaryotic-alignments)
  - [8.4 Damage Patterns](#84-damage-patterns)
    - [8.4.1 MEx-IPA](#841-mex-ipa)
    - [8.4.2 DamageProfiler](#842-damageprofiler)
  - [8.5 Laboratory Contaminants](#85-laboratory-contaminants)
- [9 Compositional Analysis](#9-compositional-analysis)
  - [9.1 Principal Coordinate Analysis](#91-principal-coordinate-analysis)
  - [9.2 Hierarchical Clustering Heatmaps](#92-hierarchical-clustering-heatmaps)
    - [9.2.1 Zero replacement validation](#921-zero-replacement-validation)
  - [9.2.2 Indicator Analysis](#922-indicator-analysis)
  - [9.3 Clustering by Diet?](#93-clustering-by-diet)
- [10 Core Microbiome Analysis](#10-core-microbiome-analysis)
  - [10.1 Core Microbiome Calculation](#101-core-microbiome-calculation)
  - [10.2 Core Microbiome MaltExtract](#102-core-microbiome-maltextract)
- [11 Genome Reconstruction and Phylogenetics](#11-genome-reconstruction-and-phylogenetics)
  - [11.1 Production dataset sequencing depth calculations](#111-production-dataset-sequencing-depth-calculations)
  - [11.2 Super-reference construction](#112-super-reference-construction)
  - [11.3 Super-reference alignment and species selection](#113-super-reference-alignment-and-species-selection)
  - [11.4 Comparative single reference mapping](#114-comparative-single-reference-mapping)
  - [11.5 Performance of super-reference vs. single genome mapping](#115-performance-of-super-reference-vs-single-genome-mapping)
  - [11.6 Variant calling and single-allelic position assessment](#116-variant-calling-and-single-allelic-position-assessment)
  - [11.7 Phylogenies](#117-phylogenies)
  - [11.8 Pre- and Post-14k BP Observation Verification](#118-pre--and-post-14k-bp-observation-verification)
    - [11.8.1 Production dataset overlapping positions analysis](#1181-production-dataset-overlapping-positions-analysis)
    - [11.8.2 Screening datasets phylogenies](#1182-screening-datasets-phylogenies)
- [12 Functional Analysis](#12-functional-analysis)
  - [12.1 Virulence Factors](#121-virulence-factors)
  - [12.2 Amylase](#122-amylase)
    - [12.2.1 Streptococcus Distribution](#1221-streptococcus-distribution)
    - [12.2.2 Amylase binding protein genes](#1222-amylase-binding-protein-genes)
  - [12.3 HUMANn2](#123-humann2)
    - [12.3.1 MetaPhlAn2](#1231-metaphlan2)
    - [12.3.2 Running HUMANn2](#1232-running-humann2)
  - [12.4 AADDER Analysis](#124-aadder-analysis)
  - [12.5 MALT RefSeq](#125-malt-refseq)
  - [12.6 Running AADDER](#126-running-aadder)
  - [12.7 Overlap between HUMAnN2 and AADDER](#127-overlap-between-humann2-and-aadder)
